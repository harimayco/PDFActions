...
async function GSPS2PDF(dataStruct, responseCallback, progressCallback, statusUpdateCallback, window) {
  ...
  xhr.onload = function () {
    ...
    const qualityConfig = getQualitySettings(dataStruct.quality);
    ...
    Module = {
      ...
      // datastruct.quality 1=low (72dpi), 2=medium (150dpi), 3=high (300dpi)
...
function getQualitySettings(qualityCode) {
  switch (String(qualityCode)) {
    case '1':
      // Low Quality / Maximum Compression: 72 DPI
      return {
        pdfSettings: '/screen',
        resolution: '72',
      };
    case '2':
      // Standard Quality / Balanced: 150 DPI
      return {
        pdfSettings: '/ebook',
        resolution: '150',
      };
    case '3':
      // High Quality / Crisp Print: 300 DPI
      return {
        pdfSettings: '/printer',
        resolution: '300',
      };
